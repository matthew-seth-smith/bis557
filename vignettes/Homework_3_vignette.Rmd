...
$$
K(x) = \frac{3}{4}(1-x^2)\chi_{\{\lvert x \rvert \leq 1\}}.
$$
...
K_h(x) & = & \frac{1}{h}K(\frac{x}{h})\\
 & = & \frac{3}{4h}\Big(1-(\frac{x}{h})^2\Big)\chi_{\{\lvert \frac{x}{h} \rvert \leq 1\}}.\\
\end{array}
$$
...
Questions:
I can't build the vignette. It is saying "Error: processing vignette 'Homework_3_vignette.Rmd' failed with diagnostics:
subscript out of bounds"
What kind of hand-made data set should I use? I've been testing it with the example in the package
How to make the indicator function in .Rmd, or how to include LaTeX package for it?
...
mean of that?
Should the 1/h also be in the function for the Epanechnikov Kernel?
Is unlist(lapply()) ok or should I just use sapply?
